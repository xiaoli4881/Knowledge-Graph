...
class medical_seg(object):
    def __init__(self):
        self.NEWPATH = '/keeson/code/dcc/code/knowledge_graph/model/medical_cws/medical_cws/pytorch_model.pkl'
        ...
        self.vocab = load_vocab('/keeson/code/dcc/code/knowledge_graph/model/medical_cws/medical_cws/vocab.txt')
        self.vocab_reverse = {v: k for k, v in self.vocab.items()}

        self.model = BERT_LSTM_CRF('/keeson/code/dcc/code/knowledge_graph/model/medical_cws/medical_cws', tagset_size, 768, 200, 2,
...
if __name__ == "__main__":
    ...
    meg = medical_seg()
    meg.predict_file('/keeson/code/dcc/code/txt文献/中国儿童阻塞性睡眠呼吸暂停诊断与治疗指南2020.txt', '/keeson/code/dcc/code/txt文献/finish/中国儿童阻塞性睡眠呼吸暂停诊断与治疗指南2020.txt')
